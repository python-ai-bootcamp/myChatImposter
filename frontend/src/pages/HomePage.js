        ...
        <div style={modalOverlayStyle} onClick={closeModal}>
          <div style={modalContentStyle} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ margin: '20px 0' }}>
              <p>Status: <strong>{linkStatus || 'Initializing...'}</strong></p>
              ...
              {qrCode ? (
                <div style={{ margin: '20px auto' }}>
                  <img
                    src={qrCode}
                    alt="QR Code"
                    style={{ border: '1px solid #ccc', padding: '10px', borderRadius: '4px', maxWidth: '100%' }}
                  />
                ...
                <div style={{ padding: '20px', color: '#666' }}>
                  {linkStatus === 'connected' ? 'Connected Successfully!' : 'Waiting for QR Code...'}
                </div>
              )}
            </div>
          </div>
