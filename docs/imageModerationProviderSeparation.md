...
- It will internally resolve the `token_consumption_collection` using the global database client and the `COLLECTION_TOKEN_CONSUMPTION` constant from `infrastructure.db_schema`.
